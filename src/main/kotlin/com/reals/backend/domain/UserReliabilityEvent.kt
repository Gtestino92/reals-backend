...
enum class UserReliabilityEventType(
    ...
    FIRST_CHAT_EARLY_UNILATERAL_CLOSE(UserReliabilityDimension.ResolutionQualityScore, -3),
    FIRST_CHAT_PARTIAL_UNILATERAL_CLOSE(UserReliabilityDimension.ResolutionQualityScore, -1),
    ...
    FIRST_CHAT_RESPONSIBLE_CLOSE_REQUEST_RESOLVED(UserReliabilityDimension.ResolutionQualityScore, 1),
    ...
    SCHEDULING_EXPIRED_ACTION_PENDING(UserReliabilityDimension.SchedulingCommitmentScore, -3),
    ...
    SAFETY_REPORT_CONFIRMED_AGAINST_USER(UserReliabilityDimension.ResolutionQualityScore, -8)
}
