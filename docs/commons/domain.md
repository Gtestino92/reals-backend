...
- `PushNotificationType`: `MATCH_FOUND`, `VISUAL_REVIEW_AVAILABLE` (historical only), `VISUAL_REVIEW_REMINDER`, `SCHEDULING_AVAILABLE`, `SCHEDULING_PROPOSALS_RECEIVED`, `SCHEDULING_CONFIRMED`, `SECOND_CHAT_REMINDER`, `SECOND_CHAT_STARTED`
