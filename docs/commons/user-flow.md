...
not a full-body detector. This does not perform profile authenticity
verification, facial recognition, face matching, liveness, legal identity
verification, age estimation or minor detection.
